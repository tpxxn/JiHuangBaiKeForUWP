...
namespace JiHuangBaiKeForUWP.Model
{
    ...
    {
        public static SolidColorBrush Common = new SolidColorBrush(Color.FromArgb(255, 153, 179, 186));
        public static SolidColorBrush Classy = new SolidColorBrush(Color.FromArgb(255, 65, 80, 120));
        public static SolidColorBrush Spiffy = new SolidColorBrush(Color.FromArgb(255, 104, 69, 124));
        public static SolidColorBrush Distinguished = new SolidColorBrush(Color.FromArgb(255, 186, 116, 166));
        public static SolidColorBrush Elegant = new SolidColorBrush(Color.FromArgb(255, 189, 70, 70));
        public static SolidColorBrush Loyal = new SolidColorBrush(Color.FromArgb(255, 146, 180, 95));
        public static SolidColorBrush Timeless = new SolidColorBrush(Color.FromArgb(255, 108, 193, 126));
        public static SolidColorBrush Event = new SolidColorBrush(Color.FromArgb(255, 180, 148, 0));
        public static SolidColorBrush ProofOfPurchase = new SolidColorBrush(Color.FromArgb(255, 76, 122, 77));
        public static SolidColorBrush Reward = new SolidColorBrush(Color.FromArgb(255, 232, 151, 81));
    }
