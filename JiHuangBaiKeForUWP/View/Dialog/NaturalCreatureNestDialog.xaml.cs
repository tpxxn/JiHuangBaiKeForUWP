...
namespace JiHuangBaiKeForUWP.View.Dialog
{
    ...
    /// </summary>
    public sealed partial class NaturalCreatureNestDialog : Page
    {
        ...
        private void SwitchLeftButton_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            if (_creatureNestIndex != 0)
            {
                ...
                NatureImage.Source = new BitmapImage(new Uri(_creatureNestList[_creatureNestIndex]));
